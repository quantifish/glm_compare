...
```{r fig_compare_pkg1, fig.cap = fig_compare_pkg1, fig.height = 12}
...
```{r fig_compare_pkg2, fig.cap = fig_compare_pkg1, fig.height = 12}
pred2 <- pred %>%
  filter(year == "2019")

ggplot(data = pred2, aes(x = year, y = Estimate, colour = Function, group = Function)) +
  geom_pointrange(aes(ymin = Q2.5, ymax = Q97.5)) +
  geom_point() +
  facet_wrap(~ Distribution, scales = "free_y", ncol = 1) +
  theme_bw() +
